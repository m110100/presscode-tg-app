				...
				>
					...
					<PopoverTrigger asChild>
						<Button
							...
							className={cn(
								'flex p-1 rounded-md border min-h-10 h-auto items-center justify-between [&_svg]:pointer-events-auto dark:bg-input/30',
												...
												return (
													...
													>
														...
														<div
															...
															className='flex flex-col justify-center items-center ml-2 h-4 w-4 cursor-pointer hover:bg-white/20 rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50'
														>
															<XCircle
																className={cn(
																	'h-3 w-3',
